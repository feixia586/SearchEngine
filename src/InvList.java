	...
	public class DocPosting {
		...
		public void insert(DocPosting dp2) {
			...
			while (dp2Pos < dp2.tf) {
				...
				// Skip positions in dp1 that are less than the current position
				// in dp2.
				...
				/*
				 * dp1Pos points to where a dp2 position can be inserted
				 * (possibly at the end of the list). If it is not a duplicate,
				 * insert it.
				 */
				if ((dp1Pos == this.tf)
						|| (this.positions.elementAt(dp1Pos) > dp2.positions
